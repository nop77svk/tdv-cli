namespace NoP77svk.TibcoDV.API
{
    ...
    {
        public async Task<int> GetIntrospectedResourceIdsTask(string dataSourcePath)
        {
        ...
        public async Task<WSDL.Admin.getIntrospectedResourceIdsResultResponse> GetIntrospectedResourceIdsResult(int taskId)
        {
